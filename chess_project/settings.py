"""Django settings configuration for the chess project.

This module contains all Django settings for the chess game application,
including database configuration, middleware, installed apps, and security settings.
...
SECRET_KEY = 'django-insecure-l_)@1l%q@6k&x_%$q$!&4yq^uf_cc&3c89ciuu#t-v#07(!0_h'
